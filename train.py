...
def main():
    ...
    las_dec = Speller(num_classes=config.model.vocab_size,
                      ...
                      sos_id=53, 
                      eos_id=54, 
                      attn_mechanism=config.model.las_dec.attn_mechanism, 
                      num_heads=config.model.las_dec.num_heads, 
                      num_layers=config.model.las_dec.num_layers, 
                      rnn_type=config.model.las_dec.type, 
